# Note (7/9/21):
I made this as an AP CS project when I was in highschool and haven't touched it since. It was mostly an excuse to learn JavaFX and should not be taken seriously. In hindsight, it is neither lightweight nor does it load very well.

# Lightweight-Java-GitHub-Loader
